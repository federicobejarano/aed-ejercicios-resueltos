...
| :---: | :----: | :---------------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------- | :----- |
|  ✅   | **1**  | [1.1.19](https://github.com/federicobejarano/aed-ejercicios-resueltos/blob/main/2_1_secuencias-de-datos-elementales/ejercicio_2.1.11.txt) | Ingresar una variable V y emitir su valor, su cuadrado y su cubo                                                                 | **E/S y Aritmética básica**                            |        |
|  ✅   | **2**  | [1.1.11](https://github.com/federicobejarano/aed-ejercicios-resueltos/blob/main/2_1_secuencias-de-datos-elementales/ejercicio_2.1.10.txt) | Dado un año, emitir si es 'ACTUAL', 'PASADO' o 'FUTURO'                                                                          | **Condicional Simple** (comparación)                   |        |
