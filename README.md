...
|✅| **6** | 1.1.6 | Ingresar 3 valores numéricos y determinar cuál es el mayor, el medio y el menor | **Condicional Anidada** (ordenamiento por comparación) | |
...
| **3** | 1.1.29 | Imprimir los números primos menores a un valor dado *n* | **Bucles Anidados** (integración del algoritmo de primalidad dentro de un bucle de recorrido) | |
